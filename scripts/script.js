...
function dragDrop(e) {
    ...
    if (beingDragged.id == whooseTurn) {
        if (droppingSquare.tagName == 'IMG') {
            ...
            else if (beingDragged.className == "king $" && beingDragged.id == "w" && kingPlacingPositions["white"].includes(droppingSquare.id)) {
            ...
            else if (beingDragged.className == "king $" && beingDragged.id == "b" && kingPlacingPositions["black"].includes(droppingSquare.id)) {
                const side = droppingSquare.id;
                if (side == "g8") {
